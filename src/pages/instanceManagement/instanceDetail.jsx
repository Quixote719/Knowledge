...
import { Breadcrumb } from 'antdForHik'
import { withRouter } from 'react-router-dom'
import { inject, observer } from 'mobx-react'
import FlowChart from '@/components/flowchart/src/main'
import styles from './index.less'
import DAGTemplate from './DAGdetail/DAGTemplate'
...
class InstanceDetail extends React.PureComponent {
    ...
    componentDidMount = () => {
        console.warn(666, this.props.history.location.state)
        if (this.props.history.location.state === undefined) {
            this.props.history.push('./InstanceManage')
        }
    }
    onWindowResize = () => {
